...
var G__13557 = o;
(G__13557[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return G__13558__delegate(args);
});
...
var G__13563 = jsprops;
(G__13563["defaultValue"] = value);

(G__13563["onChange"] = ((function (G__13563,v,value,on_change){
return (function (p1__13562_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__13562_SHARP_);
});})(G__13563,v,value,on_change))
);
...
var vec__13566 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13566,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13566,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13566,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___13570 = reagent.impl.template.key_from_vec(v);
if((temp__4661__auto___13570 == null)){
} else {
var key_13571 = temp__4661__auto___13570;
(jsprops["key"] = key_13571);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__13572 = reagent.impl.template.__GT_NativeWrapper();
(G__13572["name"] = c);
...
var G__13573 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__13573) : reagent.impl.template.as_element.call(null,G__13573));
} else {
...
var len__8814__auto___13578 = arguments.length;
var i__8815__auto___13579 = (0);
while(true){
if((i__8815__auto___13579 < len__8814__auto___13578)){
args__8821__auto__.push((arguments[i__8815__auto___13579]));

var G__13580 = (i__8815__auto___13579 + (1));
i__8815__auto___13579 = G__13580;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq13576){
var G__13577 = cljs.core.first(seq13576);
var seq13576__$1 = cljs.core.next(seq13576);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__13577,seq13576__$1);
});
...
break;
default:
var G__13583 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__13583;
continue;
...
var n__8590__auto___13585 = a.length;
var i_13586 = (0);
while(true){
if((i_13586 < n__8590__auto___13585)){
(a[i_13586] = reagent.impl.template.as_element((a[i_13586])));

var G__13587 = (i_13586 + (1));
i_13586 = G__13587;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__8590__auto___13588 = a.length;
var i_13589 = (0);
while(true){
if((i_13589 < n__8590__auto___13588)){
var val_13590 = (a[i_13589]);
if((cljs.core.vector_QMARK_(val_13590)) && ((reagent.impl.template.key_from_vec(val_13590) == null))){
(o["no-key"] = true);
} else {
}

(a[i_13589] = reagent.impl.template.as_element(val_13590));

var G__13591 = (i_13589 + (1));
i_13589 = G__13591;
continue;
} else {
}
...
var ctx = ({});
var vec__13592 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13592,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13592,(1),null);
...
var G__13595 = (cljs.core.count(argv) - first_child);
switch (G__13595) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__13595){
