...
var G__13841 = cljs.core.cst$kw$reduction_DASH_type.cljs$core$IFn$_invoke$arity$1(f);
...
return (function instaparse$reduction$iter__13845(s__13846){
return (new cljs.core.LazySeq(null,((function (reduction,temp__4655__auto__){
return (function (){
var s__13846__$1 = s__13846;
while(true){
var temp__4657__auto__ = cljs.core.seq(s__13846__$1);
if(temp__4657__auto__){
var s__13846__$2 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_(s__13846__$2)){
var c__8451__auto__ = cljs.core.chunk_first(s__13846__$2);
var size__8452__auto__ = cljs.core.count(c__8451__auto__);
var b__13848 = cljs.core.chunk_buffer(size__8452__auto__);
if((function (){var i__13847 = (0);
while(true){
if((i__13847 < size__8452__auto__)){
var vec__13849 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__8451__auto__,i__13847);
...
cljs.core.chunk_append(b__13848,(cljs.core.truth_(cljs.core.cst$kw$red.cljs$core$IFn$_invoke$arity$1(v))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,cljs.core.cst$kw$red,(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null)));

var G__13856 = (i__13847 + (1));
i__13847 = G__13856;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__13848),instaparse$reduction$iter__13845(cljs.core.chunk_rest(s__13846__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__13848),null);
}
} else {
var vec__13852 = cljs.core.first(s__13846__$2);
...
return cljs.core.cons((cljs.core.truth_(cljs.core.cst$kw$red.cljs$core$IFn$_invoke$arity$1(v))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,cljs.core.cst$kw$red,(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null)),instaparse$reduction$iter__13845(cljs.core.rest(s__13846__$2)));
}
} else {
return null;
}
